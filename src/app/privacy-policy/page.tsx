...
export const metadata: Metadata = {
  title: "개인정보 처리방침",
  description: "강쥐엄마 개인정보 처리방침. 이용자의 개인정보를 안전하게 보호하기 위한 방침입니다.",
};
  ...
  return (
    ...
    >
      <section id="intro" className="mb-12">
        ...
        <p className="mt-4">
          본 방침은 회사가 제공하는 &quot;강쥐엄마&quot; 모바일 앱 및 웹사이트(<a href="https://gangjiumma.kr" className="text-brand hover:underline">gangjiumma.kr</a>)에 적용됩니다.
        </p>
      </section>
      ...
      <section id="section-7" className="mb-12">
        ...
        <ul className="list-disc pl-6 space-y-1">
          <li>이메일: <a href="mailto:cs@gangjiumma.kr" className="text-brand hover:underline">cs@gangjiumma.kr</a></li>
      ...
      <section id="section-12" className="mb-12">
        ...
        <div className="my-4 p-5 bg-brand-tint50 rounded-2xl">
          ...
          <p>성명: 김훈기</p>
          <p>직책: 대표</p>
          <p>연락처: <a href="mailto:cs@gangjiumma.kr" className="text-brand hover:underline">cs@gangjiumma.kr</a></p>
        </div>
      </section>
