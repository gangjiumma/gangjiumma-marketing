    ...
    >
      <section className="mb-12">
        <p className="text-base md:text-lg">
          본 약관은 (주)비타니마(이하 &quot;회사&quot;)가 운영하는 반려동물 커뮤니티 서비스 &quot;AnimAI&quot;(이하 &quot;서비스&quot;)의 이용 조건 및 절차, 회사와 이용자 간의 권리·의무 및 책임사항을 규정함을 목적으로 합니다.
        </p>
      </section>

      <section id="section-1" className="mb-12">
        <h2 className="text-xl md:text-2xl font-black text-ink-1 mb-4">제1조 (목적)</h2>
        <p>본 약관은 회사가 제공하는 반려동물 커뮤니티, AI 건강 상담, 업체 정보, 건강템 추천, 산책 기록, Paw 포인트 등 AnimAI 서비스 일체의 이용 조건 및 절차, 회사와 회원 간의 권리·의무 및 책임사항을 규정함을 목적으로 합니다.</p>
      </section>

      <section id="section-2" className="mb-12">
        <h2 className="text-xl md:text-2xl font-black text-ink-1 mb-4">제2조 (용어의 정의)</h2>
        <ol className="list-decimal pl-6 space-y-2">
          <li><strong>&quot;서비스&quot;</strong>란 회사가 제공하는 AnimAI 모바일 앱, 웹사이트(animai.kr) 및 관련 일체의 서비스를 말합니다.</li>
        ...
        <ol className="list-decimal pl-6 space-y-2">
          ...
          <li>사장님 회원은 다음 행위를 할 수 없습니다.
            <ul className="list-disc pl-6 mt-2 space-y-1">
              ...
              <li>회사의 사전 동의 없이 AnimAI 브랜드/로고를 사용하는 행위</li>
            </ul>
          </li>
      ...
      <section id="section-20" className="mb-12">
        ...
        <ol className="list-decimal pl-6 space-y-2">
          ...
          <li>이용자는 회사의 고객센터(<a href="mailto:cs@vitanima.kr" className="text-brand hover:underline">cs@vitanima.kr</a>)에 분쟁 해결을 위한 의견을 제출할 수 있으며, 회사는 합리적인 기간 내에 처리 결과를 통지합니다.</li>
