  ...
  return (
    ...
    >
      <section id="intro" className="mb-12">
        ...
        <p className="mt-4">
          본 동의는 <strong>선택 사항</strong>이며, 동의를 거부하시더라도 AnimAI의 기본 서비스 이용에는 제한이 없습니다. 다만, 회사가 제공하는 다양한 혜택과 맞춤형 정보를 받지 못할 수 있습니다.
        </p>
      ...
      <section id="section-6" className="mb-12">
        ...
        <ul className="list-disc pl-6 space-y-1">
          ...
          <li><strong>고객센터:</strong> <a href="mailto:cs@vitanima.kr" className="text-brand hover:underline">cs@vitanima.kr</a>로 요청</li>
        </ul>
      ...
      <section id="section-7" className="mb-12">
        ...
        <ol className="list-decimal pl-6 space-y-2">
          ...
          <li>동의를 거부하더라도 AnimAI의 기본 서비스(커뮤니티, AI 상담, 업체 정보 등) 이용에는 제한이 없습니다.</li>
