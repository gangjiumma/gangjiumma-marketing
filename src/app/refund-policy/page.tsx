...
export const metadata: Metadata = {
  title: "환불정책",
  description: "강쥐엄마 정기결제(구독) 서비스의 환불 정책을 안내합니다.",
};
...
export default function RefundPolicyPage() {
  return (
    <LegalLayout
      title="환불정책"
      subtitle="강쥐엄마 정기결제(구독) 서비스의 환불 규정입니다."
      effectiveDate="2026년 5월 23일"
      sections={sections}
    >
      <section className="mb-12">
        <p className="text-base md:text-lg">
          본 환불정책은 (주)비타니마(이하 &quot;회사&quot;)가 운영하는 강쥐엄마(이하 &quot;서비스&quot;)의 유료 정기결제 상품에 대한 결제 취소 및 환불 기준을 정함을 목적으로 합니다. 본 정책은 「전자상거래 등에서의 소비자보호에 관한 법률」 및 관련 법령을 준수합니다.
        </p>
      </section>
      ...
      <section id="section-1" className="mb-12">
        ...
        <ol className="list-decimal pl-6 space-y-2">
          <li>본 정책은 강쥐엄마의 사장님 회원이 결제하는 정기결제(구독) 서비스 — Lite / Basic / Pro 플랜 — 에 적용됩니다.</li>
      ...
      <section id="section-3" className="mb-12">
        ...
        <ol className="list-decimal pl-6 space-y-3">
          ...
          <li>
            ...
            <ul className="list-disc pl-6 mt-2 space-y-1">
              <li>회원은 강쥐엄마 앱 내 [구독 관리] 메뉴에서 언제든지 자동결제를 해지할 수 있습니다.</li>
      ...
      <section id="section-6" className="mb-12">
        ...
        <ol className="list-decimal pl-6 space-y-2">
          <li>강쥐엄마 앱 내 [구독 관리] → [문의하기] 메뉴를 통해 환불을 신청할 수 있습니다.</li>
          <li>이메일을 통한 신청도 가능합니다.{" "}
            <a href="mailto:cs@gangjiumma.kr" className="text-brand hover:underline font-bold">cs@gangjiumma.kr</a>
          </li>
